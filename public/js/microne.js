function Microne(parent_el) {
	...
	this.p_char = ">"
	this.s_char = "||"
	$('<div style="width:100%; max-width:200px;position:absolute;right:5%;"><i style="position:relative;right:45%;" class="fa fa-volume-down"></i><i style="position:relative;left:50%;" class="fa fa-volume-up"></i><div  id="volume"></div></div>').prependTo('#player');
	$("#volume").slider({
	  	min: 0,
	  	max: 100,
	  	value: 100,
