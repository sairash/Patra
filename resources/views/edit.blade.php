...
<div class="date" id="date">New Begining</div>
  <div class="lines">
...
<script>
  musicFromUser='<?php echo $pageData[0]->audio; ?>';
...
<script type="text/javascript">
  ...
  $.notify('Happy to see you!!', {
    ...
    document.getElementById('date').innerHTML='Date:'+ yyyy+'/'+mm+'/14';
...
function totalImagesAndEmbeds(item){
  var datasForImageAndEmbeds=[];
  totalFiles=item.split("/```/");
  console.log(totalFiles);
  if (totalFiles[0].trim()!='null') {
    if (totalFiles[2].trim()=='image') {
      if (totalFiles[1].trim()!='null') {
        $('#item_direction_frontPage').append('<div id="frontPageContent'+idOfElementOfFrotPage+'"  class="item"><div class="polaroid"><div class="pin"></div><img style="width:100%;height:100%;border:none;" src='+totalFiles[0]+'><div style="width:100%;display:block;" class="caption">'+totalFiles[1]+'</div><button  onclick="deleteFrontPageData('+idOfElementOfFrotPage+')" class="deleteItemFrontPage">Delete</button></div></div>');
          datasForImageAndEmbeds=[totalFiles[0],totalFiles[1],'image']
      }else{
        $('#item_direction_frontPage').append('<div id="frontPageContent'+idOfElementOfFrotPage+'"  class="item"><div class="polaroid"><div class="pin"></div><img style="width:100%;height:100%;border:none;" src='+totalFiles[0]+'><button  onclick="deleteFrontPageData('+idOfElementOfFrotPage+')" class="deleteItemFrontPage">Delete</button></div></div>');
          datasForImageAndEmbeds=[totalFiles[0],'null','image']
      }
      
    }else{
      if (totalFiles[1].trim()!='null') {
        $('#item_direction_frontPage').append('<div id="frontPageContent'+idOfElementOfFrotPage+'"  class="item"><div class="polaroid"><div class="pin"></div><iframe style="width:100%;height:100%;border:none;" src='+totalFiles[0]+' allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><div style="width:100%;display:block;" class="caption">'+totalFiles[1]+'</div><button  onclick="deleteFrontPageData('+idOfElementOfFrotPage+')" class="deleteItemFrontPage">Delete</button></div></div>');
          datasForImageAndEmbeds=[totalFiles[0],totalFiles[1],'iframe']
      }else{
        $('#item_direction_frontPage').append('<div id="frontPageContent'+idOfElementOfFrotPage+'"  class="item"><div class="polaroid"><div class="pin"></div><iframe style="width:100%;height:100%;border:none;" src='+totalFiles[0]+' allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><button  onclick="deleteFrontPageData('+idOfElementOfFrotPage+')" class="deleteItemFrontPage">Delete</button></div></div>');
          datasForImageAndEmbeds=[totalFiles[0],'null','iframe']
      }
    }
  }

  imagesAndEmbededStuffs.push(datasForImageAndEmbeds);
  console.log(imagesAndEmbededStuffs);
}
var imagesAndEmbedsDatas='<?php echo $pageData[0]->imagesAndEmbeds; ?>'
totalFiles=imagesAndEmbedsDatas.split("/|||/");
